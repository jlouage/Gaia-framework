---
name: 'val-save'
description: 'Persist Val session decisions and findings.'
model: opus
---
...
3. Pass {project-root}/_gaia/lifecycle/workflows/4-implementation/val-save-session/workflow.yaml as 'workflow-config'
