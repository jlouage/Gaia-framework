...
function makeUxDesignContent({ state = 'draft', stakeholders = [], iterationCount = 0 } = {}) {
  const stakeholderYaml = stakeholders.length > 0
    ? `design_stakeholders:\n${stakeholders.map(s =>
...
describe('E13-S9 AC5: Token changelog', () => {
  it('should format a changelog entry with token path, change, old/new values', () => {
    ...
    const metadata = { timestamp: '2026-04-07T14:22:00Z', source: 'Figma (file: abc123, page: Main)' };
...
describe('E13-S9 AC6: Stakeholder convergence and approval', () => {
  ...
  it('should detect convergence when all tagged stakeholders approved', () => {
    const stakeholders = [
      { id: 'derek', name: 'Derek', role_tag: 'design', approved: true, approved_at: '2026-04-07T10:30:00Z' },
      { id: 'christy', name: 'Christy', role_tag: 'ux', approved: true, approved_at: '2026-04-07T11:00:00Z' },
    ];
